    ...
    <section>
     ...
     <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
       ...
       <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          ...
          <input type="text" id="name" value={name} onChange={onChange} placeholder="Full name"
           ...
           <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
             <p className="mb-6">Have an account?
               ...
               transition duration-200 ease-in-out ml-4">Sign in</Link>
             </p>
         ...
         hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg activ:bg-blue-800" type="submit">Sign Up</button>

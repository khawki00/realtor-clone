       ...
       <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
         <form>
           ...
           <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
             ...
             <p><Link to="/forgot-password" className="text-blue-600 hover:text-blue-800
               transition duration-200 ease-in-out">Forgot Password?</Link></p>
           </div>
           <button className="w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md 
         hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg activ:bg-blue-800" type="submit">Sign In</button>
